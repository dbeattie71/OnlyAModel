...
{
	public class CharacterOverview : ISendable
	{
		public byte Type => MessageType.Server.CharacterOverview;
		...
		public int Length(int protocolVersion) => _characters.Select(o => GetLength(o)).Sum() + 8;
		...
		private static int GetLength(Character c)
		{
			...
			return
				...
				c.Name.Length + 5 +
				4 + // skipped
				System.Runtime.InteropServices.Marshal.SizeOf(typeof(Customizations)) +
				13 + // skipped
				...
				2 + // model
				2 + // region
				System.Runtime.InteropServices.Marshal.SizeOf(typeof(Equipment)) +
